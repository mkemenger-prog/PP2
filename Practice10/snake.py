...
class Snake:
    ...
    def draw(self, surface):
        for i, (c, r) in enumerate(self.body):
            x = c * CELL
            y = r * CELL + HUD_H
            col = DKGREEN if i == 0 else RED
            pygame.draw.rect(surface, col,
                             (x + 2, y + 2, CELL - 4, CELL - 4),
                             border_radius=4)
            # Eyes on the head segment
            if i == 0:
                pygame.draw.circle(surface, BLACK, (x + 5,  y + 6), 3)
                pygame.draw.circle(surface, BLACK, (x + 14, y + 6), 3)
                pygame.draw.circle(surface, WHITE, (x + 5,  y + 6), 1)
                pygame.draw.circle(surface, WHITE, (x + 14, y + 6), 1)
...
class Food:
    ...
    def draw(self, surface):
        ...
        pygame.draw.circle(surface, BLUE,  (cx, cy), CELL // 2 - 2)
...
def draw_hud(surface, score: int, level: int, foods_this_level: int):
    ...
    pygame.draw.rect(surface, RED, (0, 0, SCREEN_W, HUD_H))
    pygame.draw.line(surface, GOLD, (0, HUD_H), (SCREEN_W, HUD_H), 2)
...
def draw_border(surface):
    ...
    pygame.draw.rect(surface, GRAY, (0, 0, SCREEN_W, HUD_H))   # top border (also covers HUD background)
    pygame.draw.rect(surface, GRAY, (0, HUD_H, SCREEN_W, 2))          # top border line
    pygame.draw.rect(surface, GRAY, (0, HUD_H, 2, SCREEN_H - HUD_H))    # left border
    pygame.draw.rect(surface, GRAY, (SCREEN_W - 2, HUD_H, 2, SCREEN_H - HUD_H))  # right border
